    ...
    <div style={{position:'fixed',bottom:24,right:24,zIndex:9999}}>
      {showWidget ? (
        <div className="card shadow-lg p-3" style={{minWidth:220}}>
          ...
          <a href="tel:9419170373" className="btn btn-success w-100 mb-2">
          ...
          <a href="https://www.instagram.com/saraswati_vidhyala/" target="_blank" rel="noopener noreferrer" className="btn btn-outline-danger w-100">
